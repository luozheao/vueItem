...
var getStyle = function(b, a) {
    if (!+"\v1") {
        ...
        var c = b.currentStyle[a]; (c == "auto") && (c = "0px");
        return c;
    } else {
...
var Drag = function(s) {
    var d = s,
        ...
        o = g.onEnd ||
            function() {},
        z = parseFloat(getStyle(d, "margin-left")),
        h = parseFloat(getStyle(d, "margin-right")),
        f = parseFloat(getStyle(d, "margin-top")),
        m = parseFloat(getStyle(d, "margin-bottom")),
        c,
        j,
        x,
        y,
    ...
    var v = function(J) {
        ...
        if (G) {
            ...
            x.innerHTML = d.dataNode._title; ! +"\v1" ? x.style.filter = "alpha(opacity=50)": x.style.opacity = 0.5;
    ...
    var C = function(N) {
        ...
        r && (E = d.lockX);
        q && (y = d.lockY); (x || d).style.left = E + "px"; (x || d).style.top = y + "px";
